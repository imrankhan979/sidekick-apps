const carousel = document.querySelector('.custom-scroller');
...
updateThumb();
let isDraggingThumb = false, startXThumb, startScrollLeftThumb;
...
let isDraggingCarousel = false, startXCarousel, scrollLeftCarousel;
